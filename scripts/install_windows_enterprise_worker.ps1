...
Register-ScheduledTask -TaskName "GEO Enterprise Windows Worker" -Action $Action -Trigger $Trigger -Settings $Settings -Description "Local six-model GEO diagnostic and paid-monitor worker" -Force | Out-Null
